...
/**
 * @composer components/jquery
 * @env USER_STORAGEDIRS="G_ROOTDIR.cryodrift/users/"
 * @env QMEMO_TEMPLATECACHE=false
 * @env QMEMO_CACHEDIR="G_ROOTDIR.cryodrift/cache/qmemo/"
 */
...
\cryodrift\fw\Router::addConfigs($ctx, [
  'memo/cli' => \cryodrift\qmemo\Cli::class,
], \cryodrift\fw\Router::TYP_CLI);

\cryodrift\fw\Router::addConfigs($ctx, [
  'memo' => \cryodrift\qmemo\Web::class,
  'memo/api' => \cryodrift\qmemo\Web::class,
  'memo/file' => \cryodrift\files\Web::class,
  'files/file' => \cryodrift\files\Web::class,
  'memo/api/files_delete' => [[\cryodrift\files\Api::class, 'delete', 'none', '/memo']],
  'memo/api/files_undelete' => [[\cryodrift\files\Api::class, 'undelete', 'none', '/memo']],
  'memo/api/fileviewer' => [[\cryodrift\files\Web::class, 'fileviewer', 'none', '/memo']],
  'memo/api/files_menu' => [[\cryodrift\files\Web::class, 'modefilter', 'none', '/memo']],
  'memo/api/files_search' => [[\cryodrift\files\Web::class, 'search', 'none', '/memo']],
  'memo/api/files_dirlist' => [[\cryodrift\files\Web::class, 'dirs', 'none', '/memo']],
...
\cryodrift\fw\FileHandler::addConfigs($ctx, [
  ...
  'jquery.js' => 'qmemo/ui/editor/trumbowyg/jquery.min.js',
